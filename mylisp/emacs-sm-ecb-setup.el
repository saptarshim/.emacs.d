...
;; '(ecb-auto-activate t)
 ...
 '(ecb-layout-name "SaptarshiLayoutSimple1")
 '(ecb-layout-window-sizes (quote (("SaptarshiLayoutSimple1" (0.20526315789473684 . 0.48) (0.20526315789473684 . 0.5)))))
 '(ecb-options-version "2.40")
 '(ecb-primary-secondary-mouse-buttons (quote mouse-1--mouse-2))
 '(ecb-source-path (quote (("~/projects/app/SimpleInMemDB" "SimpleInMemDB"))))
